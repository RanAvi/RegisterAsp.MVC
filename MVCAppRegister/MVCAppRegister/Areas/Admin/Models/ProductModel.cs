...
namespace MVCAppRegister.Areas.Admin.Models
{
        ...
        public class ProductModel
        {
            ...
            public int ProductLinkTexteId { get; set; }
            ...
            public string ProductLinkText
            {
                get
                {
                    return ProductLinkTexts == null || ProductLinkTexts.Count.Equals(0) ? string.Empty : ProductLinkTexts.First(pt => pt.Id.Equals(ProductLinkTexteId)).Title;
                }
            }
